...
% \section{Data mining}
% De mogelijkheden voor data mining liggen nu volledig open, een voorbeeld is de constructie van een subgraaf van de graaf die de volledige collectie voorstelt. Deze bestaat uit alle 
% 
% Eerder werd reeds vermeld a
